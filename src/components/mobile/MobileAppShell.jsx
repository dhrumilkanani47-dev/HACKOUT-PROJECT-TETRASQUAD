...
>>>>>>> fdfc26171042111c33bfb0825089fe0715a3c9e9
  ...
  return (
    <div className="min-h-screen w-full bg-[#080D1A] flex flex-row justify-start items-stretch antialiased selection:bg-emerald-100 selection:text-emerald-900 overflow-hidden">
        ...
        <div className="mt-4 pt-4 border-t border-slate-800/80 flex flex-col gap-2">
          <div className="flex items-center bg-slate-800/90 border border-slate-700/70 rounded-xl p-0.5">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold transition-all ${deviceMode === 'framed'
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold transition-all ${deviceMode === 'fluid'
                  ? 'bg-emerald-500 text-slate-950 shadow-xs'
                  : 'text-slate-400 hover:text-white'
                }`}
      ...
      <main className="flex-1 h-screen w-full flex items-center justify-center p-0 md:p-6 overflow-hidden bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(16,185,129,0.12),rgba(8,13,26,0))]">
        {deviceMode === 'framed' ? (
          ...
          <div className="w-full md:max-w-[395px] h-screen md:h-[844px] bg-slate-950 md:rounded-[44px] p-0 md:p-[8px] md:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9),0_0_0_8px_#1e293b] md:border md:border-slate-800 relative flex flex-col transition-all overflow-hidden">
            ...
            <div className="hidden md:block absolute -left-[12px] top-[110px] w-[3px] h-[25px] bg-slate-700 rounded-l-sm" />
            <div className="hidden md:block absolute -left-[12px] top-[150px] w-[3px] h-[45px] bg-slate-700 rounded-l-sm" />
            <div className="hidden md:block absolute -left-[12px] top-[205px] w-[3px] h-[45px] bg-slate-700 rounded-l-sm" />
            {/* Right Power Button Accent */}
            <div className="hidden md:block absolute -right-[12px] top-[140px] w-[3px] h-[60px] bg-slate-700 rounded-r-sm" />
          ...
          <div className="w-full max-w-md min-h-screen bg-white md:shadow-2xl md:rounded-2xl md:border md:border-slate-200 overflow-y-auto overflow-x-hidden flex flex-col justify-start relative select-none">
            {children}

            {/* Home Indicator bar on mobile/frame */}
            <div className="w-full py-1.5 flex justify-center items-center shrink-0 bg-white/95 mt-auto">
              <div className="w-32 h-1 bg-slate-300 rounded-full" />
            </div>
          </div>
        )}
